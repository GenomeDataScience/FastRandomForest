 ...
 * @version $Revision$
 */
public class MyRandomTree extends AbstractClassifier implements OptionHandler,
            ...
            if (attribute.isNominal()) {
                ...
                for (int i = 0; i < indexOfFirstMissingValue; i++) {
                    ...
                    if (inst.value(att) > currSplit) {
                        currVal =
                                MyRandomTree.variance(currSums, currSumSquared, currSumOfWeights);
                        if (currVal < bestVal) {
                            bestVal = currVal;
...
//            Attribute attribute = data.attribute(att);
    ...
    public static void main(String[] argv) {
        runClassifier(new MyRandomTree(), argv);
    }
}